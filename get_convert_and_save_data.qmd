...
performance_patterns <- c("Brews & Blues", "A Christmas Carol")
...
# ---- The transparent, readable, maintainable pipeline ----
...
evcat2 <- evcat1 |>
  mutate(
    event_majorcat = case_when(
      ...
      str_detect(event_name, pattern_collapse(performance_patterns)) ~
        "performance",
